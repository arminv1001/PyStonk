...
st.sidebar.markdown(
    'Search for stock ticker symbol for any company in [Yahoo Finance](https://finance.yahoo.com/)')
...
with plotly:
    ...
    fig.add_trace(go.Scatter(
        x=ticker_data['Date'], y=ticker_data['Open'], name="stock_open"))
    fig.add_trace(go.Scatter(
        x=ticker_data['Date'], y=ticker_data['Close'], name="stock_close"))
    fig.layout.update(
